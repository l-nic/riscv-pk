...
DECLARE_CSR(lownid, CSR_LOWNID)
DECLARE_CSR(lread, CSR_LREAD)
DECLARE_CSR(lmsgsrdy, CSR_LMSGSRDY)
DECLARE_CSR(lrdend, CSR_LRDEND)
DECLARE_CSR(lrdsrciplo, CSR_LRDSRCIPLO)
DECLARE_CSR(lrdsrciphi, CSR_LRDSRCIPHI)
DECLARE_CSR(lrdsrcprt, CSR_LRDSRCPRT)
DECLARE_CSR(lwrite, CSR_LWRITE)
DECLARE_CSR(lwrend, CSR_LWREND)
DECLARE_CSR(lwrdstiplo, CSR_LWRDSTIPLO)
DECLARE_CSR(lwrdstiphi, CSR_LWRDSTIPHI)
DECLARE_CSR(lwrdstprt, CSR_LWRDSTPRT)
